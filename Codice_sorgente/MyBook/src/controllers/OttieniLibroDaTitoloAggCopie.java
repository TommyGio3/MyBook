...
@WebServlet("/ottieniLibroDaTitoloAggCopie")
public class OttieniLibroDaTitoloAggCopie extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//Ottieni i parametri dalla pagina di aggiornamento copie e 
		//filtrali per evitare sql injection
		...
		String error = null;
		try {
			// query db per validare titolo e autore e ottenere l'ISBN corrispondente
		...
		if (error != null) {
			...
			String path = "/dettaglioAggCopie.jsp";
