...
@WebServlet("/ottieniLibroDaTitolo")
public class OttieniLibroDaTitolo extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//Ottieni i parametri e filtrali per evitare sql injection
		...
		String error = null;
		try {
			// query db per controllare la validità di titolo e autore ed ottenere l'ISBN del libro
			idLibro = lDAO.validaTitoloAutore(titolo, autore);
			// query db per trovare il libro da ISBN
		...
		if (error != null) {
			...
			String path = "/dettaglioPrezzo.jsp";
