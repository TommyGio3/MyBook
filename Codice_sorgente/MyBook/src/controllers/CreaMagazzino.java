...
@WebServlet("/creaMagazzino")
@MultipartConfig
public class CreaMagazzino extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String idNegozioStr = request.getParameter("negozioSelect");
		...
		try {
			// quey db per creare un nuovo magazzino
			mDAO.creaMagazzino(città, indirizzo, idNegozio);
		...
		if (error != null) {
			...
			String path = getServletContext().getContextPath() + "/succAggMagazzino.html";
			response.sendRedirect(path);
		}
	}
