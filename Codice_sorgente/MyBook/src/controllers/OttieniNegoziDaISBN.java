...
@WebServlet("/ottieniNegoziDaISBN")
public class OttieniNegoziDaISBN extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String error = null;
		try {
			// query db per ottenere i negozi che contengono il libro dall'ISBN
			negozi = nDAO.ottieniNegoziDaISBN(ISBN);
		...
		if (error != null) {
			...
			String json = gson.toJson(negozi);
