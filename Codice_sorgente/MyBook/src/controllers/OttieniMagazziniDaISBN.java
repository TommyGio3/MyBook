...
@WebServlet("/ottieniMagazziniDaISBN")
public class OttieniMagazziniDaISBN extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String error = null;
		try {
			// query db per ottenere i magazzini che appartengono al negozio e che 
			// contengono il libro 
			magazzini = mDAO.ottieniMagazziniDaISBNeIdNegozio(ISBN, idNegozio);
